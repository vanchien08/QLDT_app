...
import login.raven.swing.ButtonOutLine;
...
public class PanelCover extends javax.swing.JPanel {
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        GradientPaint gra = new GradientPaint(0, 0, new Color(17, 45, 96), 0, getHeight(), new Color(221, 131, 224));
        g2.setPaint(gra);
    ...
    public void login(boolean login) {
        if (this.isLogin != login) {
            if (login) {
                ...
                button.setText("Creat account");
            } else {
                title.setText("Welcome Back!!");
                description.setText("To keep connected with us please");
                description1.setText("Đăng nhập bằng thông tin cá nhân của bạn");
                button.setText("SIGN IN");
            }
            this.isLogin = login;
        }
