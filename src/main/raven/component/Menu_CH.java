package main.raven.component;

import mainNV.raven.event.EventMenuSelected;
import mainNV.raven.model.Model_Menu;
...
public class Menu_CH extends javax.swing.JPanel {
    ...
    private void init() {
        listMenu1.addItem(new Model_Menu("1", "Trang chủ", Model_Menu.MenuType.MENU));
         ...
         listMenu1.addItem(new Model_Menu("8", "Thông tin các nhân", Model_Menu.MenuType.MENU));
          listMenu1.addItem(new Model_Menu("8", "Hóa đơn Nước", Model_Menu.MenuType.MENU));
...
//        listMenu1.addItem(new Model_Menu("", "", Model_Menu.MenuType.EMPTY));
    ...
    private void initComponents() {
        ...
        listMenu1 = new mainNV.raven.swing.ListMenu<>();
    ...
    private mainNV.raven.swing.ListMenu<String> listMenu1;
