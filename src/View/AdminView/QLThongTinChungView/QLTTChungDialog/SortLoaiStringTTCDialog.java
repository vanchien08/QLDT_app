...
public class SortLoaiStringTTCDialog extends javax.swing.JDialog {

    private Form_1 QlttChungMainView;
    public  Personal_Infos Ps;
    
    public SortLoaiStringTTCDialog( Form_1 qLTTChungMainView, boolean modal) {
        initComponents();
    ...
    public void SortDialog(int loaiSapXep){
        Object selected = QlttChungMainView.getSapXepCkb().getSelectedItem();
        if(selected.equals("Theo CCCD")){
            DSThongTinChung.Sorting(loaiSapXep, 1, QlttChungMainView.getBangDSTTChung());
        }else if(selected.equals("Theo họ và tên")){
            DSThongTinChung.Sorting(loaiSapXep, 2, QlttChungMainView.getBangDSTTChung());                
        }else if(selected.equals("Theo địa chỉ")){
            DSThongTinChung.Sorting(loaiSapXep, 3, QlttChungMainView.getBangDSTTChung());                
        }else if(selected.equals("Theo SĐT")){
            DSThongTinChung.Sorting(loaiSapXep, 4, QlttChungMainView.getBangDSTTChung());                
        }        
    }
