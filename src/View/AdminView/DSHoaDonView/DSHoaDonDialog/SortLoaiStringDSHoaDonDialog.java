...
import View.AdminView.DSNhanVienView.DSNhanVienDialog.*;
...
public class SortLoaiStringDSHoaDonDialog extends javax.swing.JDialog {
    ...
    private Form_5 dSHoaDonMainView;
    
    public SortLoaiStringDSHoaDonDialog( Form_5 dSHoaDonMainView, boolean modal) {
        initComponents();
        this.dSHoaDonMainView = dSHoaDonMainView;
    ...
    public void SortDialog(int loaiSapXep){
        Object selected = dSHoaDonMainView.getSapXepCkb().getSelectedItem();
        if(selected.equals("Theo ID")){
            DSHoaDonController.Sorting(loaiSapXep, 1, dSHoaDonMainView.getBangDSHoaDon());
        }else if(selected.equals("Theo CCCD")){
            DSHoaDonController.Sorting(loaiSapXep, 2, dSHoaDonMainView.getBangDSHoaDon());                
        }else if(selected.equals("Theo họ và tên(CH)")){
            DSHoaDonController.Sorting(loaiSapXep, 3, dSHoaDonMainView.getBangDSHoaDon());                
        }else if(selected.equals("Theo họ và tên(NV)")){
            DSHoaDonController.Sorting(loaiSapXep, 4, dSHoaDonMainView.getBangDSHoaDon());                
        }else if(selected.equals("Theo Ngày ")){
            DSHoaDonController.Sorting(loaiSapXep, 5, dSHoaDonMainView.getBangDSHoaDon());                
        }else if(selected.equals("Theo Tổng tiền")){
            DSHoaDonController.Sorting(loaiSapXep, 6, dSHoaDonMainView.getBangDSHoaDon());                
        }          
    }
